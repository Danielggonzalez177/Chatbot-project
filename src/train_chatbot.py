...
# Add a dense layer with the number of units equal to the number of classes and softmax activation function
model.add(Dense(len(train_y[0]), activation="softmax"))

# Create an SGD optimizer with specified parameters
sgd = SGD(learning_rate=0.01, weight_decay=1e-6, momentum=0.9, nesterov=True)

# Compile the model with categorical crossentropy loss function and the SGD optimizer
